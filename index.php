               ...
               <a href="" ><img src="images/logo.png" width="50px" height="45px" ></a>
                ...
                <nav>
                    <ul id="menu">
                        ...
                        <li><a href="C:\Users\ADMIN\Desktop\html\project\supp\index.html">Resource</a></li>
        ...
        <div class="container1">
            <div class="small-container">
                <div class="row1">
                    ...
                    <div class="colm" action="process.php" method="post">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="process.php" method="post">
                        ...
                        <input type="text" name="Number" placeholder="Conact number" class="form-control mb-2">          
